  ...
  if (activeTab === 'tasks') {
    return (
      <div className="space-y-8 max-w-5xl mx-auto">
        ...
        {/* 流程图区域 */}
        <div className="flex justify-center max-w-4xl mx-auto my-6">
            <div 
                className="flex-1 h-14 bg-brand-400 text-white flex flex-col items-center justify-center relative shadow-sm hover:scale-105 transition-transform cursor-pointer animate-in fade-in slide-in-from-left duration-500"
                style={{ clipPath: 'polygon(0% 0%, 90% 0%, 100% 50%, 90% 100%, 0% 100%)', zIndex: 30 }}
            >
                <span className="text-[10px] opacity-90 font-bold uppercase tracking-wider">任务一</span>
                <span className="text-sm font-bold">调查选题</span>
            </div>
            <div 
                className="flex-1 h-14 bg-brand-500 text-white flex flex-col items-center justify-center relative shadow-sm hover:scale-105 transition-transform cursor-pointer -ml-4 animate-in fade-in slide-in-from-left duration-500 delay-150"
                style={{ clipPath: 'polygon(10% 0%, 90% 0%, 100% 50%, 90% 100%, 10% 100%, 0% 50%)', zIndex: 20 }}
            >
                <span className="text-[10px] opacity-90 font-bold uppercase tracking-wider">任务二</span>
                <span className="text-sm font-bold">过程性材料</span>
            </div>
            <div 
                className="flex-1 h-14 bg-brand-600 text-white flex flex-col items-center justify-center relative shadow-sm hover:scale-105 transition-transform cursor-pointer -ml-4 animate-in fade-in slide-in-from-left duration-500 delay-300"
                style={{ clipPath: 'polygon(10% 0%, 100% 0%, 100% 100%, 10% 100%, 0% 50%)', zIndex: 10 }}
            >
                <span className="text-[10px] opacity-90 font-bold uppercase tracking-wider">任务三</span>
                <span className="text-sm font-bold">调查报告</span>
            </div>
        </div>
