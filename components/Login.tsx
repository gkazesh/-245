...
export const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-white font-sans text-slate-800 relative">
      {/* Background Image: Full Screen for Books Theme */}
      <div className="absolute inset-0 w-full h-full">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-slate-900/90 to-slate-800/50 flex flex-col justify-end p-16 text-white">
      ...
      <div className="relative z-10 w-full h-full flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8 bg-white/95 backdrop-blur-sm p-10 rounded-xl shadow-2xl border border-slate-100">
